...
class InvoiceDomainTest {
    ...
    void mapperBuildsLiveQuoteAndImmutableReceipt() {
        ...
        StoreDetails store = new StoreDetails(
                ...
                4, ReceiptWidth.MM_58, InvoicePrintFormat.THERMAL,
                A4InvoiceTemplate.MODERN, ThermalReceiptTemplate.CLASSIC,
                false, 0, NOW, NOW);
        ...
        assertThat(response.store().invoicePrintFormat()).isEqualTo(InvoicePrintFormat.THERMAL);
